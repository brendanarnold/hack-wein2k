...
!
      RVFAC= 1.d0/WURZEL
      ORTHO=.TRUE.
      if(abs(alpha(1)-pi/2.d0).gt.0.0001d0) ortho=.false.
      if(abs(alpha(2)-pi/2.d0).gt.0.0001d0) ortho=.false.
      if(abs(alpha(3)-pi/2.d0).gt.0.0001d0) ortho=.false.
!
      GOTO 100
!
!.....FC LATTICE                                                        
...
!.....CXZ ORTHOROMBIC CASE 
      IF(ABS(ALPHA(3)-PI/2.0D0).LT.0.0001d0) then
         BR1(1,1)=PIA(1)                                                   
         BR1(1,2)=0.0D0                                                    
         BR1(1,3)=0.0D0                                                    
         BR1(2,1)=0.0D0                                                    

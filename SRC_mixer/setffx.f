      SUBROUTINE SETFFx(nkk,ifft1,ifft2,ifft3,rhok,fft,kzz)
!
...
!      COMMON /GENER/   BR1(3,3),br2(3,3),avec(3,3)                 
      CHARACTER*67  ERRMSG
      COMPLEX*16 FFT(IFFT1,IFFT2,IFFT3),rhok(Nkk),TAUP(NSYM)          
  ...
  9   FFT(I1,I2,I3)=0.0d0                                           
      DO 2 I=1,NKK                                                      
      CALL STERN(I,NST,KKK,TAUP,kzz,nkk)                                        
      DO 3 J=1,NST                                                      
      ii1=kkk(1,j)
      ii2=kkk(2,j)
      ii3=kkk(3,j)
...
!        Error messages
!
  900 CALL OUTERR('SETFFX','ifft too small in xcpot3')
      WRITE (ERRMSG,9000)

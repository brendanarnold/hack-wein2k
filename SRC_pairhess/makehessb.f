      subroutine makehessb(translat,nuse,distances,pred,hess,br1,N1,N2,steps)
...
!           Gradient
            call gradb(translat,nuse,distances,xred,g1,br1,N1,N2,steps)
!
!           Copy: sometimes might be needed
            do n=1,nat
               do ii=1,3
...
!           Shift
            xred(i,j)=pred(i,j)-steps(i)
!
            call gradb(translat,nuse,distances,xred,g2,br1,N1,N2,steps)
!
!           Hessian terms
            ind2=0
            do k=1,nat
...
!
      subroutine gradb(translat,nuse,distances,pred,gred,br1,N1,N2,steps)
      implicit real*8 (a-h,o-z)
      include 'params.inc'
...
!
            E1=energyb(translat,distances,br1,nuse,xred,N2)
!
!           Copy: sometimes might be needed
            do n=1,nat
               do ii=1,3
...
!
            E2=energyb(translat,distances,br1,nuse,xred,N2)

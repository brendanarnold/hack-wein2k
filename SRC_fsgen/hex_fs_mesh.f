...
!
      write(*,*) 'generates fermi surface mesh in hex case:'
      write(*,*) 'plane Gamma-M-K:     1'
      ...
      if(ind.eq.1) then
        ...
        if(i.eq.1)then
          ...
          write(2,'(i10,4i5,f5.2)') i,ix*2-iy,iy*2,0,mesh*2,1.0
        endif
        enddo
        enddo
        write(2,'(a)') 'END'
        ...
        i=i+1
        if(i.eq.1)then
          write(2,'(i10,4i5,3f5.2,5x,2i4)') i,0,0,mesh,mesh*2,1.0,-7.,1.5, &
                                     mesh/2+1,mesh/3+1
        else
          write(2,'(i10,4i5,f5.2)') i,ix*2-iy,iy*2,mesh,mesh*2,1.0
        endif
        enddo
        enddo
        write(2,'(a)') 'END'

      SUBROUTINE SETFF2(nkk,ifft1,ifft2,ifft3,rhoksp,fft)
!
!.....adds rhoksp to fft-field (for one spin only)
!
      use struct
...
!
      CHARACTER*67  ERRMSG
      COMPLEX*16 FFT(IFFT1,IFFT2,IFFT3),rhoksp(NKK,2),TAUP(NSYM)          
      dimension kkk(3,NSYM)
!      DO 9 I1=1,IFFT1
!      DO 9 I2=1,IFFT2
!      DO 9 I3=1,IFFT3                                                   
!      FFT(I1,I2,I3,1)=0.0d0                                           
!  9   FFT(I1,I2,I3,2)=0.0d0                                           
      DO 2 I=1,NKK                                                      
...
!      IF(I1.EQ.0.AND.I2.EQ.0) WRITE(*,*) I3,KKK(3,J),RHOK(I)           
      FFT(I1+1,I2+1,I3+1)=FFT(I1+1,I2+1,I3+1)+RHOKSP(I,1)*TAUP(J)/nst                      
!      FFT(I1+1,I2+1,I3+1,2)=FFT(I1+1,I2+1,I3+1,2)+RHOKSP(I,2)*TAUP(J)/nst                      
    3 CONTINUE                                                          
    2 CONTINUE                                                          
      return
!

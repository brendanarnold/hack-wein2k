      SUBROUTINE EV92EX(D,S,U,V,EX,VX)
!engel
...
!engel
      ...
      PARAMETER( a1 =  1.64712732976569 )
      PARAMETER( a2 =  .9801182732515644 )
      PARAMETER( a3 =  1.739938440729993E-02 )
      PARAMETER( b1 =  1.52367053964223 )
      PARAMETER( b2 =  .3672289494300232 )
      PARAMETER( b3 =  1.128174995137635E-02 )

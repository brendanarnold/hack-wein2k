      SUBROUTINE SETFF1(nkk,ifft1,ifft2,ifft3,rhoksp,fft)
!
...
!        Error messages
!
  900 CALL OUTERR('SETFF1','ifft too small in xcpot3')
      WRITE (ERRMSG,9000)
      CALL OUTERR('SETFF1',ERRMSG)
      WRITE (ERRMSG,9010) (KKK(II,J),II=1,3)
      CALL OUTERR('SETFF1',ERRMSG)
      WRITE (ERRMSG,9020) ii1,ii2,ii3
      CALL OUTERR('SETFF1',ERRMSG)
      WRITE (ERRMSG,9030) IFFT1,IFFT2,IFFT3
      CALL OUTERR('SETFF1',ERRMSG)
      STOP 'XCPOT3 - Error'
!
!        End of 'SETFF1'

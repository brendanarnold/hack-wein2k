      SUBROUTINE VXC26(FU,GXU,GYU,GZU,GMAGU,G2U,GGXU,GGYU,GGZU, &
...
! EXCHANGE POTENTIAL OF EV93 UP
      ...
      U=GDGG/(TKF*(FU*TKF)**2)
      V=G2U/(FU*TKF**2)
      CALL EV92EX(D,S,U,V,EXUP1,VXUP)
! EXCHANGE ENERGY OF PW91 DN
      D=2.D0*FD
...
! EXCHANGE POTENTIAL OF EV93 DN
      ...
      U=GDGG/(TKF*(FD*TKF)**2)
      V=G2D/(FD*TKF**2)
      CALL EV92EX(D,S,U,V,EXDN1,VXDN)
! LOCAL CORRELATION
      D=FU+FD
      RS=(0.75D0/(PI*D))**THRD
      ZET=(FU-FD)/D

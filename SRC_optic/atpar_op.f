...
!      COMMON /POTNLC/  VR(NRAD),RNOT(NATO),DX(NATO),JRI(NATO)           
      real*8 VR(NRAD)
...
!                                                                       
      E1=EI-DELE                                                        
      CALL OUTWIN(REL,VR,RNOT(JATOM),DX(JATOM),JRI(JATOM),E1,            &
...
!                                                                       
      CALL OUTWIN(REL,VR(1),RNOT(JATOM),DX(JATOM),JRI(JATOM),EI,         &
...
!                                                                       
  ...
  80    CONTINUE                                                          
        ...
        WRITE(6,8) L,P(l),DP(l),PE(l),                                     &
             DPE(l),PEI(l),NODEL,NODES,NODE                         
  70  CONTINUE
!
!   now for LO's
!                         
...
!     CALCULATE FUNCTION AT EI                                          
!                                                                       
        CALL OUTWIN(REL,VR(1),RNOT(JATOM),DX(JATOM),JRI(JATOM),     &
...
!ad
        ...
        DO 180 I=1,IMAX                                                    
          ...
          b1lo(I,l)=B(I)
 180    CONTINUE                                                   
        WRITE(6,8) L,Plo(l),DPlo(l),PElo(l),                                     &
                 DPElo(l),PEIlo(l),NODEL,NODES,NODE                         
 170  continue
      do l=0,lomax
         do jlo=1,ilo(l)

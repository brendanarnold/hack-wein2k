...
! !ROUTINE: Resld
! !INTERFACE:
      SUBROUTINE RESLD (NQN,NQL,NK,IMAX,DE,DFL,DQ1,JC,RELA)             
! !USES:
      use initialstate1
	  use dimension_constants,only : nrad
! !INPUT/OUTPUT PARAMETERS:
!   nqn  : main quantum number of core state
!   nql  : orbital quantum number of core state
!   nk   : relativistic (kappa) quantum number of core state
!   imax : index specifying last point of wave function
!   dfl  : puissance du premier terme du développement limité
!   dq1  : pente à l'origine de dp ou dq
!   jc  :   I don't know
!   de  :   "
!   rela    :  switch for relativistic/nonrelativistic calculations
! !DESCRIPTION:
...
!  added KJ : common block content used to be called with different name ...
      test=tets
!  end KJ	  	  

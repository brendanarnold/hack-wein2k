...
!                                                                       
!.....RHOMBOHEDRAL CASE                                                    
 60   BR1(1,1)=1.D0/SQRT(3.D0)
      BR1(1,2)=1.D0/SQRT(3.D0)
      BR1(1,3)=-2.d0/sqrt(3.d0)
      BR1(2,1)=-1.0d0
      BR1(2,2)=1.0d0
      BR1(2,3)=0.0d0
      BR1(3,1)=1.0d0
...
!      CALL ROTDEF (NAT)                                            
      ...
      READ(20,'(i4)') IORD                                                  
      DO  J=1,IORD                                                     
       READ(20,11) ((IMAT(J1,J2,J),J1=1,3),TAU(J2,J),J2=1,3),inum(j) 
      enddo
!.....READ IN SYMMETRY OPERATIONS AND NONPRIMITIVE TRANSLATIONS         
 11   FORMAT(3(3I2,F11.5/),i8)                                              
      CALL ROTDEF(imat,tau,iord,nat,pos,ndif,rotij,tauij,mult,lattic)
!
      RETURN
!
!        Error messages

      SUBROUTINE NN(NAT,touch,POS,Alat,ALPHA, &
      RMT,V,PIA,VOL,IATNR,MULT,ISPLIT,stpmax)
...
!                                                                       
      ...
      RETURN                                                            
  910 write(6,*)'overlapping spheres'
      WRITE (6,9000) JATOM,RMT(JATOM),N3,RMT(N3)
      WRITE (6,9010) SUMRAD, DISTS(N1)
      touch=.true.
      IF(stpmax.lt.0.05) GOTO 920
      RETURN                                                            

...
!
      GOTO 100
!
! 20   IF(ABS(ALPHA(3)-PID/2.0D0).GT.0.0001) THEN
!      WRITE(*,*) 'GAMMA NOT EQUAL 90'
!      GOTO 21     
!      ENDIF
!      IF(ABS(ALPHA(2)-PID/2.0D0).GT.0.0001) THEN
...
!.....CXZ ORTHOROMBIC CASE
      IF(ABS(ALPHA(3)-PID/2.0D0).LT.0.0001) then
         BR1(1,1)=PIA(1)                                                   
         BR1(1,2)=0.0D0                                                    
         BR1(1,3)=0.0D0                                                    
         BR1(2,1)=0.0D0                                                    
...
! 21   CONTINUE
!
!     IF(ABS(ALPHA(2)-PID/2.).GT.0.0001) GOTO 61
!     GAMMA NE 90                                     
!      SINAB=SIN(ALPHA(3))
!      COSAB=COS(ALPHA(3))
!      BR1(1,1)= PIA(1)/SINAB                                                  

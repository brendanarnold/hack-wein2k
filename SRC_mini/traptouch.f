!
      SUBROUTINE traptouch(x,p,n,stpmax,nat,touch)
      use atomgrid
...
!      write(*,*)' in pairdis  ---------- '
!      write(*,*)'  rr = '
!      write(*,300)((rr(i,j),i=1,3),j=1,np)
!      write(*,*)'  gg = '
!      write(*,300)gg
!      write(*,*)'  pp = '
!      write(*,300)((pp(i,j),i=1,3),j=1,np)
!      write(*,*)'  pos2 = '
!      write(*,300)((pos2(i,j),i=1,3),j=1,index)
 110  format(30i3)
 300  format(3f16.8)
      call nn(nat,touch,POS2,Alat,ALPHA,RMT,V,PIA,VOL,IATNR,MULT,ISPLIT,  &
             stpmax)
!      write(*,*)'  maxstp: ',stpmax
!      Simply return if the atoms touch
!      if (touch) goto 200

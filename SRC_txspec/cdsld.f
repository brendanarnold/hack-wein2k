...
! **********************************************************************
 ...
 2012 FORMAT (20X,'RM',I2,' (',I1,A2,',',I1,A2,',',I1,A2,',',I1,A2,') =' &
      ,1PE14.7)                                                         
      READ(7,1000) IRM,INS,NPUN,NMFG,NMRK                              
!                                                                       
...
! **********************************************************************
      ...
      WRITE (6,2000) BAR                                                
 1    READ(7,1000) J,L,N1,L1,J1,N2,L2,J2                               
      IF (L.EQ.0) GO TO 21                                              
!                                                                       

      SUBROUTINE INSLD(RELA,npxx,cform)                                            
!                                                                       
...
! **********************************************************************
 ...
 47   DV(I)=FPOT(R,Z,VAL)                                               
      ...
      DO 48 I=1,NUC                                                     
 48   DV(I)=DV(I)+Z/DR(I)+Z*((DR(I)/DR(NUC))**2-3.)/(DR(NUC)+DR(NUC))   
      GO TO 101                                                         
 58   READ(18,1980)                                                      
      READ(18,2000) IDUMMY                                               
      READ(18,2031)                                                      
      READ(18,iform1) ( DV(I), I=1,NP )                                    
      READ(18,2033)                                                      
      READ(18,2031)                                                      
      NPXX=40                                                           
      I=2*(np/2)+1  

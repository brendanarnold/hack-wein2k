...
!     IMPLICIT REAL (D)                                                 
      ...
      ZEL(30,2),NORB                                                    
! ..... SPINPOLARIZATION NOT IMPLEMENTED                                
      COMMON/DIRA/DV(NPT),DR(NPT),DP(NPT),DQ(NPT),DPAS,Z,NSTOP,NES,TETS, &
      NP,NUC                                                            
      COMMON/DEUX/DVN(NPT),DVF(NPT),D(NPT),DC(NPT),DGC(NPT,30),DPC(NPT,30)                                                                
      DIMENSION TITRE(*),BAR(10)                                        
 1000 FORMAT (8I3)                                                      
 2000 FORMAT (/,20X,10A4,/)                                           
 2001 FORMAT (/,'    ERREUR POUR LA CARTE   ',8I3)                    
 ...
 2010 FORMAT (' GM',I2,' (',I1,A2,',',I1,A2,')',5X,'(-1)=',1PE14.7,5X,'(0)=',1PE14.7,5X,'(+1)=',1PE14.7)                                  
 2011 FORMAT (/,20X,'INTEGRALES MAGNETIQUES RK=INTEGRALE DE P1(1)*Q2(1)*UK(1,2)*P3(2)*Q4(2)'//)                                           
 2012 FORMAT (20X,'RM',I2,' (',I1,A2,',',I1,A2,',',I1,A2,',',I1,A2,') =',1PE14.7)                                                         

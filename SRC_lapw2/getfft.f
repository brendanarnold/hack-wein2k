...
!
      ...
      do 22 j=1,nwave
         ...
         do jj=1,NST
            ...
            I2=stg(2,jj)
            I3=stg(3,jj)
            IF(IABS(i1).GT.2*kmax(1)) GOTO 22
            IF(IABS(i2).GT.2*kmax(2)) GOTO 22
            IF(IABS(i3).GT.2*kmax(3)) GOTO 22
            IF(I1.LT.0) I1=I1+IFFT1                                         
            IF(I2.LT.0) I2=I2+IFFT2                                         
            IF(I3.LT.0) I3=I3+IFFT3                                         
            rho1(index)=FFT(I1+1,I2+1,I3+1)                  
!            write(*,777) index,FFT(I1+1,I2+1,I3+1),i1+1,i2+1,i3+1
! 777        FORMAT(i3,' extracting',2f12.9,' from position',3i5)
         enddo
 22   continue
      return
      end

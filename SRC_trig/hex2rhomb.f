...
!.... End of changes by P.Blaha
      ...
      H(3,3)=1.d0
!      
      R(1,1)=0.2886751345948d0
      R(1,2)=-0.5d0
      R(1,3)=0.3333333333333d0
      R(2,1)=0.2886751345948d0
      R(2,2)=0.5d0
      R(2,3)=0.3333333333333d0
      R(3,1)=-.5773502691896d0
      R(3,2)=0.d0
      R(3,3)=0.3333333333333d0
!       DO 712 I=1,3
!       DO 712 J=1,3
!       INDEX=(I-1)*3+J

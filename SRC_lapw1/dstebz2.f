      SUBROUTINE DSTEBZ2( RANGE, ORDER, N, VL, VU, IL, IU, ABSTOL, D, E, &
...
!  =======
!
!  DSTEBZ2 computes the eigenvalues of a symmetric tridiagonal
...
!          eigenvalues.  (DSTEBZ2 may use the remaining N-M elements as
!          workspace.)
!
...
!          belongs.  (DSTEBZ2 may use the remaining N-M elements as
!          workspace.)
!

      SUBROUTINE ZHETRD2( UPLO, N, A, LDA, D, E, TAU, WORK, LWORK,  &
                          BLOCK, INFO )
      IMPLICIT NONE
!
...
!     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER            INFO, LDA, LWORK, N, BLOCK
!     ..
!     .. Array Arguments ..
...
!  =======
!
!  ZHETRD2 reduces a complex Hermitian matrix A to real symmetric

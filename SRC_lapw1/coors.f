      SUBROUTINE COORS(RKM,NT,SX,SY,SZ,NAT,nmat_only)
!
...
!         CALL OUTERR('COORS','NVEC1 too small.')
            write(6,*) 'NVEC1 too small.',nvec1loc,ja,rk(nv),rkq
            nvec1loc=nvec1loc*2
      ELSEIF (JB .EQ. NV2) THEN
!         CALL OUTERR('COORS','NVEC2 too small.')
            write(6,*) 'NVEC2 too small.',nvec2loc,jb,rk(nv),rkq
            nvec2loc=nvec2loc*2
      ELSE
!         CALL OUTERR('COORS','NVEC3 too small.')
            write(6,*) 'NVEC3 too small.',nvec3loc,jc,rk(nv),rkq
            nvec3loc=nvec3loc*2
      ENDIF

      SUBROUTINE DSYEVX2( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU, &
                         ABSTOL, M, W, Z, LDZ, WORK, LWORK, IWORK, &
                         IFAIL, BLOCK, NUME, NBVL, INFO )
        IMPLICIT NONE
!
...
!          where NB is the blocksize for DSYTRD2 returned by ILAENV.
!
...
!     .. External Subroutines ..
      EXTERNAL           DCOPY, DLACPY, DORGTR, DORMTR, DSCAL, DSTEBZ, &
                         DSTEIN, DSTEQR, DSTERF, DSWAP, DSYTRD2, XERBLA
!     ..
!     .. Intrinsic Functions ..
...
!
   ...
   20       CONTINUE
      ...
      END IF
!
!     Call DSYTRD2 to reduce symmetric matrix to tridiagonal form.
!
      INDTAU = 1
      INDE = INDTAU + N
      INDD = INDE + N
      ...
      CALL DSYTRD2( UPLO, N, A, LDA, WORK( INDD ), WORK( INDE ), &

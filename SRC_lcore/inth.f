...
! ********************************************************************* 
      ...
      DPR=DP+DM*((251.d0*DEP(1)+2616.d0*DEP(3)+1901.d0*DEP(5))-(1274.d0*DEP(2)+2774.d0*DEP(4)))                                                     
      DQR=DQ+DM*((251.d0*DEQ(1)+2616.d0*DEQ(3)+1901.d0*DEQ(5))-(1274.d0*DEQ(2)+2774.d0*DEQ(4)))                                                     
      DO 13 I=2,5                                                       
      DEP(I-1)=DEP(I)                                                   
 13   DEQ(I-1)=DEQ(I)                                                   
      DSUM=(DB-DV/DVC)*DR                                               
      ...
      DP=DP+DM*((106.d0*DEP(2)+646.d0*DEP(4)+251.d0*DEP(5))-(19.d0*DEP(1)+264.d0*DEP(3)))                                                           
      DQ=DQ+DM*((106.d0*DEQ(2)+646.d0*DEQ(4)+251.d0*DEQ(5))-(19.d0*DEQ(1)+264.d0*DEQ(3)))                                                           

subroutine make_list_R(res,add,zero,molf,translate)
   ...
   BR(1,1)=1.0d0/SQRT(3.0d0)/2.0d0*aa                                         
   BR(1,2)=-0.5d0*bb                                                
   BR(1,3)=1.0d0/3.0d0*cc                                                
   BR(2,1)=1.0d0/SQRT(3.0d0)/2.0d0*aa                                         
   BR(2,2)=0.5d0*bb                                                
   BR(2,3)=1.0d0/3.0d0*cc
   BR(3,1)=-1.0d0/SQRT(3.0d0)*aa                                         
   BR(3,2)=0.0d0                                         
   BR(3,3)=1.0d0/3.0d0*cc
